...
NOTE: `/nav/destination`, `/nav/status`, and `/nav/cancel` are deprecated. Use <<actions.adoc#action-dori-nav-navigate_to,`/nav/navigate_to` action>> for goal, feedback, and cancel control.
