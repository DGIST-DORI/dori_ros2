...
*Frequency*:: Expected: N/A, Actual: TBD
*QoS*:: Reliability: Reliable, Durability: Volatile
*Flow*:: depth_camera_node → /camera/color/image_raw → person_detection_node, gesture_recognition_node, facial_expression_node, landmark_detection_node
...
*Frequency*:: Expected: N/A, Actual: TBD
*QoS*:: Reliability: Reliable, Durability: Volatile
*Flow*:: depth_camera_node → /camera/depth/image_raw → person_detection_node, landmark_detection_node
...
*Frequency*:: Expected: N/A, Actual: TBD
*QoS*:: Reliability: Reliable, Durability: Volatile
*Flow*:: depth_camera_node → /camera/color/camera_info → landmark_detection_node
...
*Frequency*:: Expected: N/A, Actual: TBD
*QoS*:: Reliability: Reliable, Durability: Volatile
*Flow*:: depth_camera_node → /camera/depth/camera_info → (none documented)
...
*Frequency*:: Expected: N/A, Actual: TBD
*QoS*:: Reliability: Reliable, Durability: Volatile
*Flow*:: depth_camera_node → /camera/depth/image_colormap → (none documented)
...
*Frequency*:: Expected: N/A, Actual: TBD
*QoS*:: Reliability: Reliable, Durability: Volatile
*Flow*:: (none documented) → /camera/depth/scale → person_detection_node
