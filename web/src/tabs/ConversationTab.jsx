/**
 * tabs/ConversationTab.jsx — Conversation Replay
 *
 * 기능:
 *   1. 세션 추출  — log에서 Wake Word 기준으로 대화 세션을 자동 파싱
 *   2. 채팅 뷰    — 사용자 발화 / DORI 응답을 채팅 버블로 시각화
 *                   컨텍스트 이벤트(Gesture, NAV, State 변화)는 인라인 표시
 *   3. 저장/불러오기 — 세션을 JSON으로 export / import
 *   4. 재주입     — 선택한 발화를 /dori/stt/result 로 다시 publish (LLM 재테스트)
 *   5. 타임라인   — 세션 내 이벤트를 시간축으로 시각화
 */
