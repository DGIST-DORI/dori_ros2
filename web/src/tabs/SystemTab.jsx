...
import {
  ...
  valueClass,
  hzClass,
} from '../panels/system/shared/formatters';
...
export function TopicDiagnosticsPanel({ className = 'sys-panel-diag' }) {
...
export function MetricsPanel({ className = 'sys-panel-metrics' }) {
